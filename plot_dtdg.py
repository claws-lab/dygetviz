...
from dygetviz.utils.utils_misc import project_setup, get_visualization_name
from dygetviz.utils.utils_training import pairwise_cos_sim
from dygetviz.utils.utils_visual import get_colors, get_hovertemplate
from dygetviz.visualization.anchor_nodes_generator import get_dataframe_for_visualization
...
def get_visualization_cache(dataset_name: str, device: str, model_name: str,
    ...
    for nn in num_nearest_neighbors:
        ...
        for idx, node in enumerate(
            ...
            if node_presence.dtype == np.float64:
                # Convert float64 array to int array
                node_presence = node_presence.astype(np.int64)
